-- =============================================================================
-- APALIS MIGRATION — DO NOT MODIFY
-- Copied from apalis-sqlite. These migrations are managed by the apalis crate
-- and run through sqlx's migrator so everything uses one migration system.
-- If you upgrade apalis, check for new migrations in the apalis-sqlite crate.
-- =============================================================================
